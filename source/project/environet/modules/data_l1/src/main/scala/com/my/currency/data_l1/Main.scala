...
import org.environet.shared_data.Utils.loadKeyPair
import org.environet.shared_data.app.ApplicationConfigOps
import org.environet.shared_data.daemons.DaemonApis
import org.environet.shared_data.types.codecs.JsonBinaryCodec
...
object Main extends CurrencyL1App(
  "environet-data_l1",
  "environet data L1 data node",
  ClusterId(UUID.fromString("517c3a05-9219-471b-a54c-21b7d72f4ae5")),
  tessellationVersion = TessellationVersion.unsafeFrom(org.tessellation.BuildInfo.version),
  metagraphVersion = MetagraphVersion.unsafeFrom(org.environet.data_l1.BuildInfo.version)
) {
